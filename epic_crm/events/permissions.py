...
class IsTheAssignedSalespersonOrManager(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        elif request.user.role == UserRole.Roles.SALESPERSON and 'contract' in request.data:
...
class IsTheAssignedOrManagerObject(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.user == obj.contract.client.salesperson or request.user == obj.technical_support or request.user.role == UserRole.Roles.MANAGER:
            return True
