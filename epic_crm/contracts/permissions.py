...
class IsTheAssignedSalespersonOrManager(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        elif request.user.role == UserEpic.Roles.SALESPERSON and 'client' in request.data:
...
class IsTheAssignedSalespersonOrManagerObject(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.user == obj.client.salesperson or request.user.role == UserEpic.Roles.MANAGER:
            return True
