...
class TestContractWithSalespeople:
    ...
    def test_salesperson_can_list_contracts(self, api_client_salesperson):
    ...
    def test_assigned_salesperson_can_create_a_new_contract(self, api_client_salesperson):
        ...
        response = api_client_salesperson.post('/contracts/', data=body)
        data = response.json()
    ...
    def test_assigned_salesperson_can_update_a_contract(self, api_client_salesperson):
        ...
        response = api_client_salesperson.put(f'/contracts/{contract_to_update.pk}/', data=body)
        data = response.json()
    ...
    def test_salesperson_cannot_delete_a_contract(self, api_client_salesperson):
        ...
        # --
        response = api_client_salesperson.delete(f'/contracts/{contract_to_delete.pk}/')
        data = response.json()
